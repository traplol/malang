...
struct IR_Unary_Operation : IR_RValue
{
    ...
    IR_Unary_Operation(const Source_Location &src_loc, IR_Value *operand)
        : IR_RValue(src_loc)
        , operand(operand)
        {}
...
struct IR_U_Not : IR_Unary_Operation
{
    ...
    IR_U_Not(const Source_Location &src_loc, IR_Value *operand)
        : IR_Unary_Operation(src_loc, operand)
        {}
...
struct IR_U_Invert : IR_Unary_Operation
{
    ...
    IR_U_Invert(const Source_Location &src_loc, IR_Value *operand)
        : IR_Unary_Operation(src_loc, operand)
        {}
    virtual struct Method_Info *get_method_to_call() const override;
    IR_NODE_OVERRIDES;
...
struct IR_U_Negate : IR_Unary_Operation
{
    ...
    IR_U_Negate(const Source_Location &src_loc, IR_Value *operand)
        : IR_Unary_Operation(src_loc, operand)
        {}
    virtual struct Method_Info *get_method_to_call() const override;
    IR_NODE_OVERRIDES;
...
struct IR_U_Positive : IR_Unary_Operation
{
    ...
    IR_U_Positive(const Source_Location &src_loc, IR_Value *operand)
        : IR_Unary_Operation(src_loc, operand)
        {}
    virtual struct Method_Info *get_method_to_call() const override;
    IR_NODE_OVERRIDES;
